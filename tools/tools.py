# Via Phil Wang https://github.com/lucidrains/toolformer-pytorch/blob/main/toolformer_pytorch/tools.py
# by way of Enrico Shippole https://github.com/conceptofmind/toolformer/blob/main/tools.py
...
def bing_search(input_query: str, num_results: int = 10):
